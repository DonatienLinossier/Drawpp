...
if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/../include/SDL2/SDL_version.h")
    message(AUTHOR_WARNING "Could not find SDL_version.h. This script is meant to be placed in the root of SDL2-devel-2.x.y-VC")
    return()
endif()

# Modified it to SDL2/ so it works(tm)
file(READ "${CMAKE_CURRENT_LIST_DIR}/../include/SDL2/SDL_version.h" _sdl_version_h)
